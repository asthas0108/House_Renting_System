            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex gap-6 flex-wrap '>
                    <div className='flex items-center gap-2'>
                        <input type='number' id='bedrooms' min='1' max='10' className='p-2 border-gray-300 rounded' 
                            required
                            onChange={handleChange}
                    ...
                    <div className='flex items-center gap-2'>
                        <input type='number' id='bathrooms' min='1' max='10' className='p-2 border-gray-300 rounded' 
                            required
                            onChange={handleChange}
                    ...
                    <div className='flex items-center gap-2'>
                        <input type='number' id='regularPrice' min='5000' max='100000' className='p-2 border-gray-300 rounded' 
                            required
                            onChange={handleChange}
                    ...
                    {formData.offer && (
                        <div className='flex items-center gap-2'>
                            <input type='number' id='discountPrice' min='0' max='100000' className='p-2 border-gray-300 rounded' 
                                required
                                onChange={handleChange}
